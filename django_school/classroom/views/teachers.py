...
from ..forms import BaseAnswerInlineFormSet, QuestionForm, TeacherSignUpForm, QuestionFormWithoutPost
from ..models import Answer, Question, Quiz, User, Subject, Topics
...
def question_add(request, pk):
    ...
    # print(subject)
    # topic = get_object_or_404(Topics, pk=topic_pk, owner=request.user)
    # print(topic)
    # queryset = Quiz.objects.all()
    # print(get_list_or_404(queryset, pk=pk, owner=request.user))
